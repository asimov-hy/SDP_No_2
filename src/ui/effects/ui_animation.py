...
ui_animation.py
---------------
Provides general-purpose animation and tweening helpers for UI elements.

Theoretical Purpose
-------------------
This module defines reusable logic for animating UI properties
such as position, scale, color, or opacity.
